...
package com.DecaInt.DecaInt32.DecaInt32;
...
class DecaInt32 {
        ...
        protected void setRawValue(int num) {
            rawValue = num;
        }
        ...
        // TODO: make the methods with an extra parameter static
        ...
        public DecaInt32 powDecaInt32(DecaInt32 num1, int num2) {
            // This method is faster than the other algorithm
            if(num2 < 0) {
                return this.divideDecaInt32(toDecaInt32(1), this.powDecaInt32(num1, 0-num2));
            } else if (num2 == 0) {
                // TODO: prevent precision change
                return toDecaInt32(1);
            } else if (num2 % 2 == 0) {
                DecaInt32 temp = this.powDecaInt32(num1, num2 / 2);
                return temp.multiplyDecaInt32(temp);
            } else {
                return this.multiplyDecaInt32(num1, powDecaInt32(num1, num2 - 1));
            }
        }

        public DecaInt32 powDecaInt32(int num2) {
            return powDecaInt32(this, num2);
        }
